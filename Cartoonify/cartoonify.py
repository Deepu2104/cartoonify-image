...
def main():
    ...
    Font_b1 = ("Comic Sans MS", 16, "bold")
    Font_b2= ("Chalkduster", 13, "bold")
    Font_b3= ("Marker Felt", 14, "bold")
    Font_b4= ("Comic Sans MS", 14,"bold")
    Font_b5= ("Palatino", 16,"bold")
    Font_b6= ("Chalboard SE", 15,"bold")
    Font_lab=("Arial Hebrew", 17 , "bold")

    #Application window
    panel=tkinter.Tk()
    panel.geometry('600x400+380+50')
    ...
    #Buttons
    #Smooth Outlines
    btn_1 = Button(panel,text="Smooth Outlines", command=b1,font=Font_b1,height= 3, width=13, bg = 'blue', fg='yellow').place(x=10, y=50)
    #Black Board & Chalks
    btn_2 = Button(panel,text="Black Board & Chalks", command=b2,font=Font_b2,height= 4, width=20,fg='yellow').place(x=180, y=50)
    #Black Pen Sketch
    btn_3 = Button(panel,text="Black Pen Sketch", command=b3,font=Font_b3,height= 4, width=15,fg='yellow').place(x=400, y=50)
    #Pencil Sketch
    btn_4 = Button(panel,text="Pencil Sketch", command=b4,font=Font_b4,height= 3, width=14,fg='yellow').place(x=10, y=150)
    #Colour Pencil
    btn_5 = Button(panel,text="Colour Pencil", command=b5,font=Font_b5,height= 3, width=22,fg='yellow').place(x=180, y=150)
    #Crayons
    btn_6 = Button(panel,text="Crayons", command=b6,font=Font_b6,height= 3, width=13,fg='yellow').place(x=400, y=150)
